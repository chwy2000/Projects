...
public class ProcesoImpl1 extends UnicastRemoteObject implements Proceso1 {

    protected ProcesoImpl1() throws RemoteException {
        super();
    }

    @Override
    public Map<String, String> procesarArchivo(String palabra) throws RemoteException {
